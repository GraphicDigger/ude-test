...
// Header перенесён в canonical layout: `src/components/Component-header/Component.tsx`.
// MultiComponent сохраняется как fixture multi-root файла (Footer + LoginForm).
